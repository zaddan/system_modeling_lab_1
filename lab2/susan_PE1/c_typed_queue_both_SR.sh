...
//#include "i_typed_sender_both_SR.sh"
//#include "i_typed_receiver_both_SR.sh"
//#include "i_typed_tranceiver_both_SR.sh"
//

#define DEFINE_C_TYPED_QUEUE(typename, type)				\
									\
channel c_ ## typename ## _queue_both_SR(in const unsigned long size, OSAPI myOS)		\
...
{									\
	...
	{								\
        ...
        t = myOS.pre_wait();\
        wait r;							\
        printf("I am in rcving in Q both_SR \n");\
        myOS.post_wait(t);\
        wr--;							\
	}								\
									\
  ...
  /*myStart*/\ 
channel c_ ## typename ## _queue_S(in const unsigned long size, OSAPI myOS) \
      implements i_ ## typename ## _sender,				\
		i_ ## typename ## _receiver,				\
		i_ ## typename ## _tranceiver				\
{									\
  ...
  /*myStart ******/\
channel c_ ## typename ## _queue_R(in const unsigned long size, OSAPI myOS)\
        implements i_ ## typename ## _sender,				\
		i_ ## typename ## _receiver,				\
		i_ ## typename ## _tranceiver				\
{									\
